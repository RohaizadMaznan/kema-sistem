  ...
  return (
    <>
      <tr className="hover:bg-gray-100 border-b border-gray-200 py-10">
        ...
        <td className="px-4 py-4 hover:text-blue-500 cursor-pointer capitalize">
          {desc}
        </td>
        <td className="px-4 py-4 hover:text-blue-500 cursor-pointer">
          RM {value}
        </td>
        <td className="px-4 py-4 hover:text-blue-500 cursor-pointer">{date}</td>
        <td className="px-4 py-4 text-center flex justify-center">
        <span
            className="hover:text-green-600 hover:underline cursor-pointer mx-1"
            title="Edit"
          >
            <Link to={`/bendahari/transaction/update/${id}`}>
              <svg
          ...
          <span
            ...
            title="Edit"
          >
            <Link to={`/bendahari/transaction/download/${id}`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="none"
