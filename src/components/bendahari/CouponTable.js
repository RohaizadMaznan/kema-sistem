...
export default function CouponTable({
  ...
  const quote = `Share coupon code! ${code} and only limit to ${limit} redemptions!`;
  const iconSize = "24";
  ...
  return (
    <>
      <tr className="hover:bg-gray-100 border-b border-gray-200 py-10">
        <td className="px-4 py-4 hover:text-blue-500 cursor-pointer">{code}</td>
